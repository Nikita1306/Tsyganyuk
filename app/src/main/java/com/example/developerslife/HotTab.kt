...
class HotTab : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.hot_tab_fragment, container, false)
         imageView = root.findViewById(R.id.hot_gif)
         textView = root.findViewById(R.id.hot_description)
        val buttonNext: ImageButton = root.findViewById(R.id.button_next_hot)
        buttonRetry = root.findViewById(R.id.button_retry_hot)
        val buttonPrevious: ImageButton = root.findViewById(R.id.button_previous_hot)
        errorMessage = root.findViewById(R.id.error_text_hot)
        var currentGif = 0
        var flagDone = false
        var isError = false
        ...
        cl = root.findViewById(R.id.gifLayoutHot)
        currentPage = 0
        val url = "https://developerslife.ru/hot/$currentPage?json=true"
        ...
        buttonRetry.setOnClickListener{
            if (isOnline(context!!)) {
                ...
                isError = false
                loadGif("https://developerslife.ru/hot/$currentPage?json=true", currentGif)
            }
        }
